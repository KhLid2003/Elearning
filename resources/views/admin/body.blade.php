        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row g-4">
                <div class="col-sm-6 col-xl-3">
                    ...
                    >
                        <i
                            class="fa fa-chart-line fa-3x text-primary"
                        ></i>
                        <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    ...
                    >
                        <i
                            class="fa fa-chart-bar fa-3x text-primary"
                        ></i>
                        <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    ...
                    >
                        <i
                            class="fa fa-chart-area fa-3x text-primary"
                        ></i>
                        <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    ...
                    >
                        <i
                            class="fa fa-chart-pie fa-3x text-primary"
                        ></i>
                        <div class="ms-3">
